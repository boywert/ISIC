## @package docstring
#  ISIC (Isothermal Initial Condition generator)
import numpy
from pylab import *
...
## Physical constant (do not change, please)
#
...
#
def create_gadget_header(npart,mass,time,redshift,num_files,boxsize,OmegaLambda):
    ...
    pointer_hdr['OmegaLambda'] = 1.0 - pointer_hdr['Omega0']
    pointer_hdr['HubbleParam'] = 0.0
    return pointer_hdr

def create_position_field():
    return 0

def create_velocity_field():
    return 0

def write_gadget_file(file,gadget_data):
